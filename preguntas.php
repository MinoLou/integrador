...
<div style="color:white;"> <!-- section hace bolonqui -->
    ...
    <br>
    <h2>¿Quiénes pueden utilizar Construworld?</h2>
    <h3>Cualquier persona mayor de 18 años, residente en CABA y área metropolitana (previa aceptación de los Términos de Uso de Servicios).</h3>
    <br>
    <h2>¿Construworld emite facturas por los servicios?</h2>
    <h3> Los prestadores de Construworld son <strong>PyMEs o trabajadores independientes habilitados<em>, por los que ellos se encuentran obligados a emitir facturas por los trabajos realizados.</h3>
    <br>
