...
<!-- Servicios -->
<html>
	<p class="registro">Listado de maestros mayores de obra</p>
...
<?php
	...
	if($json_previo){	//Si hay al menos un usuario
		...
		foreach($previo as $valor){
			if($valor['profesion'] == 'maestro-mayor-de-obra'){
				echo "<p style='font-size: 20px;'>". $valor['nombre'] . '&nbsp&nbsp&nbsp&nbsp' ."<a href='gestion.php?profesion=maestro mayor de obra&nombre=" .$valor['nombre']."'>Contactar</a></p></br>";
