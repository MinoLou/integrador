...
<!-- Servicios -->
<html>
	<p class="registro">Listado de electricistas</p>
...
<?php
	...
	if($json_previo){	//Si hay al menos un usuario
		...
		foreach($previo as $valor){
			if($valor['profesion'] == 'electricista'){
				echo "<p style='font-size: 20px;'>". $valor['nombre'] . '&nbsp&nbsp&nbsp&nbsp' ."<a href='gestion.php?profesion=electricista&nombre=" .$valor['nombre']."'>Contactar</a></p></br>";
