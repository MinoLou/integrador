...
<!-- Servicios -->
<html>
	<p class="registro">Listado de carpinteros</p>
...
<?php
	...
	if($json_previo){	//Si hay al menos un usuario
		...
		foreach($previo as $valor){
			if($valor['profesion'] == 'carpintero'){
				echo "<p style='font-size: 20px;'>". $valor['nombre'] . '&nbsp&nbsp&nbsp&nbsp' ."<a href='gestion.php?profesion=carpintero&nombre=" .$valor['nombre']."'>Contactar</a></p></br>";
